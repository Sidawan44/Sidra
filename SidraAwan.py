...
id = raw_input('\033[1;96m \x1b[1;93mID/Email \x1b[1;91m: \x1b[1
...
def pilih():
	...
	if unikers =="":
		...
		os.system('rm -rf login.txt')
		keluar()
	else:print "\033[1;96m \x1b[1;91mFill in correctly"
		pilih()
def super():
	global toket
	os.system('clear')
